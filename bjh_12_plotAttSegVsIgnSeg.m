...
%%% PRE-PAUSES
    ...
    for s = 1:size(subj_info_bjh_blink,2)
        if logical(minBlinks100(s))
            ...
            title(['\bf{Participant ',num2str(str2double(sList{s})),'}',newline,...
                ...
                'Number of Pre-pauses: ',num2str(size(attPrepausesWithBlink,2)),'/',...
                num2str(size(ignPrepausesWithBlink,2)),newline,'Avg. Pre-pause Duration: '...
    ...
    print(gcf,[pathoutSegWithBlink,'prepauseAttVsPrepauseIgn_nPerm',num2str(nPerm)],'-dpng','-r300'); 
...
%%% PAUSES
    ...
    print(gcf,[pathoutSegWithBlink,'pauseAttVsPauseIgn_nPerm',num2str(nPerm)],'-dpng','-r300'); 
